...
function _init() {
    ...
    $.mynotepedia.layout = {
        activate: function () {
            ...
            if ($("body").hasClass("fixed"))$(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight()); else {
                ...
                var e = $($.mynotepedia.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        }, fixSidebar: function () {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugins!"), void($.mynotepedia.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({destroy: !0}).height("auto"), $(".sidebar").slimscroll({
        ...
        activate: function (a) {
            var b = $.mynotepedia.options.screenSizes;
            ...
            }), ($.mynotepedia.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        }, expandOnHover: function () {
            var a = this, b = $.mynotepedia.options.screenSizes.sm - 1;
    ...
    }, $.mynotepedia.tree = function (a) {
        var b = this, c = $.mynotepedia.options.animationSpeed;
        ...
        activate: function () {
            var a = this, b = $.mynotepedia.options.controlSidebarOptions, c = $(b.selector), d = $(b.toggleBtnSelector);
...
if ("undefined" == typeof jQuery)throw new Error("mynotepedia requires jQuery");
$.mynotepedia = {}, $.mynotepedia.options = {
    ...
    "use strict";
    $("body").removeClass("hold-transition"), "undefined" != typeof mynotepediaOptions && $.extend(!0, $.mynotepedia.options, mynotepediaOptions);
    var a = $.mynotepedia.options;
    _init(), $.mynotepedia.layout.activate(), $.mynotepedia.tree(".sidebar"), a.enableControlSidebar && $.mynotepedia.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
        height: a.navbarMenuHeight,
        alwaysVisible: !1,
        size: a.navbarMenuSlimscrollWidth
    }).css("width", "100%"), a.sidebarPushMenu && $.mynotepedia.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({selector: a.BSTooltipSelector}), a.enableBoxWidget && $.mynotepedia.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(document).on("click", a.directChat.contactToggleSelector, function () {
    ...
    a.fn.activateBox = function () {
        a.mynotepedia.boxWidget.activate(this)
    }, a.fn.toggleBox = function () {
        var b = a(a.mynotepedia.boxWidget.selectors.collapse, this);
        a.mynotepedia.boxWidget.collapse(b)
    }, a.fn.removeBox = function () {
        var b = a(a.mynotepedia.boxWidget.selectors.remove, this);
        a.mynotepedia.boxWidget.remove(b)
    }
}(jQuery), function (a) {
    "use strict";
