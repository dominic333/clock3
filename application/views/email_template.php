...
<table border="0" cellpadding="0" cellspacing="0" align="center"
    ...
    <tr>
        <td align="left" style="width: 30%; padding-left: 10px;  padding-top: 10px; padding-bottom: 10px;">
            <img src="<?php echo base_url(); ?>images/site/logo_login2.png" alt="clock-in.me"/>
        </td>
        <td align="right"
    ...
    <tr>
        <td colspan="3" align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
            ...
            <h1 style="font-size: 23px;"><span style="color: #f61d3a;"><strong><i>Congratulations !</i></strong></span>
            </h1>
            <p style="font-size: 27px">Everybody is on time</p>
            <img src="<?php echo base_url(); ?>images/email-1.png" width="70px">
            <img src="<?php echo base_url(); ?>images/email-2.png" width="70px">
            <img src="<?php echo base_url(); ?>images/email-3.png" width="70px">
            <img src="<?php echo base_url(); ?>images/email-4.png" width="70px">
            <img src="<?php echo base_url(); ?>images/email-5.png" width="70px">
        </td>
    </tr>
