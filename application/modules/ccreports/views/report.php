                            ...
                            <div class="col-md-12">
                                <div class="box box-danger">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title"><p>Shift Attendance Report</p></h3>

                                        <div class="row">
                                            <form role="form" id="frm_department_attendance"
                                                  name="frm_department_attendance"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group date" data-provide="datepicker"
                                                            ...
                                                            <input type="text" class="form-control" placeholder="From"
                                                                   ...
                                                                   value="<?php echo (isset($date_from)) ? $date_from : set_value('date_from'); ?>"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group date" data-provide="datepicker"
                                                            ...
                                                            <input type="text" class="form-control" placeholder="To"
                                                                   ...
                                                                   value="<?php echo (isset($date_to)) ? $date_to : set_value('date_to'); ?>"
                                                                   data-date-format="dd-mm-yyyy">
                                                            <div class="input-group-addon">
                                                                <span class="glyphicon glyphicon-th"></span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-control select2" style="width: 100%;"
                                                            ...
                                                            <?php foreach ($company_shifts as $shift) { ?>
                                                                <option
                                                                    value="<?php echo $shift->shift_id; ?>" <?php echo(isset($multiSelect) && ($multiSelect == $shift->shift_id) ? 'selected="selected"' : set_select('multiSelect', $shift->shift_id)); ?> >
                            ...
                            <div class="col-md-12">
                                <div class="box box-danger">
                                    <div class="box-header">
                                        ...
                                        <form role="form" id="frm_user_attendance" name="frm_user_attendance"
                                              action="<?php echo base_url(); ?>ccreports/reports/" method="post">
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="input-group date" data-provide="datepicker"
                                                             id='dpfromuser'>
                                                            <input type="text" class="form-control" placeholder="From"
                                                                   id="udate_from" name="udate_from"
                                                                   value="<?php echo (isset($udate_from)) ? $udate_from : set_value('udate_from'); ?>"
                                                                   data-date-format="dd-mm-yyyy">
                                                            <div class="input-group-addon">
                                                                <span class="glyphicon glyphicon-th"></span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="input-group date" data-provide="datepicker"
                                                             id='dptouser'>
                                                            <input type="text" class="form-control" placeholder="To"
                                                                   id="udate_to" name="udate_to"
                                                                   value="<?php echo (isset($udate_to)) ? $udate_to : set_value('udate_to'); ?>"
                                                                   data-date-format="dd-mm-yyyy">
                                                            <div class="input-group-addon">
                                                                <span class="glyphicon glyphicon-th"></span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <select class="form-control select2" style="width: 100%;"
                                                                id="umultiSelect" name="umultiSelect">
                                                            <option
                                                                value="all" <?php echo(isset($umultiSelect) && ($umultiSelect == 'all') ? 'selected="selected"' : set_select('umultiSelect', 'all')); ?>>
                                                                -- Select All --
                                                            </option>
                                                            <?php foreach ($company_members as $member) { ?>
                                                                <option
                                                                    value="<?php echo $member->staff_id; ?>" <?php echo(isset($umultiSelect) && ($umultiSelect == $member->staff_id) ? 'selected="selected"' : set_select('umultiSelect', $member->staff_id)); ?> >
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <button type="button" id="download_user_attendance_link"
                                                                class="btn btn-primary full-search">
